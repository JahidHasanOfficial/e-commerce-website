                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            <h4 class="mb-0 font-size-18">Edit Brands</h4>
                            <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.brands.update', $brand->slug) }}" method="POST"
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ old('name', $brand->name) }}" placeholder="Enter Your Brand Name">
                                            @error('name')
